...
<div class="col-md-4 col-md-push-2  col-xs-12 ">
	...
	<div align="center">
		<br>
		<p>Not registered yet? <a target="_blank" style="color:Blue" href='superadmin.php'>Register Here</a></p>
	</div>
	...
	<div style="font-size :18px; border-style: none  none none dotted; border-width: 2px; border-color: rgba(0, 0, 0, 0.2); height: 390px;text-align: justify;" class="col-md-4 col-md-push-2  col-xs-12 "><br>This the main system login form for to access the system. you can enter both Super and Basic admin login details. if you are not a member of system create your login access with using <a target="_blank" style="color:Blue" href='superadmin.php'>Register Here</a>
<br>
